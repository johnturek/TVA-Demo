...
$proc = Start-Process -FilePath $venvPython -ArgumentList @("mcp_server.py") -WorkingDirectory $mcpRoot -RedirectStandardOutput $stdoutLog -RedirectStandardError $stderrLog -WindowStyle Hidden -PassThru
